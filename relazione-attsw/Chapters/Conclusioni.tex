...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}{In questo modo vengono esclusi da \textbf{qualsiasi controllo} di web security tutti gli URL relativi alle \textsl{risorse} dell'applicazione (file HTML, CSS\dots). Se questo fosse stato fatto nel metodo \textsl{configure(HttpSecurity)} non sarebbe stato possibile utilizzare accedere alle pagine HTMl, utilizzare i webjars (Bootstrap nello specifico)}
\end{minipage}
